...
# ── Pull Docker Image ─────────────────────────────────────────────────────────
echo "Pulling Docker image: 976792586595.dkr.ecr.us-east-1.amazonaws.com/rivet-prod:latest"
docker pull 976792586595.dkr.ecr.us-east-1.amazonaws.com/rivet-prod:latest
...
docker run -d \
    ...
    976792586595.dkr.ecr.us-east-1.amazonaws.com/rivet-prod:latest
